...
public class SearchService {
     ...
     */
    public List<MedicalFile> searchMedicalFiles(int userId, SearchCriteria criteria) {
     ...
     */
    public List<User> searchUsers(String searchTerm, User.UserType userType, boolean onlyVerified) {
    ...
    public List<String> getSearchSuggestions(int userId, String query, String type) {
        ...
        try (Connection conn = DatabaseConfig.getConnection();
            ...
            System.err.println("Search suggestions failed: " + e.getMessage());
        }
    ...
    public List<CategoryCount> getFileCountByCategory(int userId) {
        ...
        try (Connection conn = DatabaseConfig.getConnection();
            ...
            try (ResultSet rs = stmt.executeQuery()) {
                while (rs.next()) {
                    MedicalFile.FileCategory category = MedicalFile.FileCategory.valueOf(rs.getString("category"));
                    int count = rs.getInt("count");
                    counts.add(new CategoryCount(category, count));
                }
            }
        } catch (SQLException e) {
            System.err.println("Category count failed: " + e.getMessage());
        }
     ...
     */
    public List<MedicalFile> getRecentFiles(int userId, int limit) {
        List<MedicalFile> files = new ArrayList<>();
        ...
        try (Connection conn = DatabaseConfig.getConnection();
            ...
            System.err.println("Recent files query failed: " + e.getMessage());
        }
    ...
    private MedicalFile mapResultSetToMedicalFile(ResultSet rs) throws SQLException {
        ...
        file.setCategory(MedicalFile.FileCategory.valueOf(rs.getString("category")));
    ...
    public static class SearchCriteria {
        ...
        private MedicalFile.FileCategory category;
        ...
        public MedicalFile.FileCategory getCategory() { return category; }
        public void setCategory(MedicalFile.FileCategory category) { this.category = category; }
    ...
    public static class CategoryCount {
        private final MedicalFile.FileCategory category;
        private final int count;
        
        public CategoryCount(MedicalFile.FileCategory category, int count) {
